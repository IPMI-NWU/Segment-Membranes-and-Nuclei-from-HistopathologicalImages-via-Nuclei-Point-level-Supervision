...
def main(image_path, label_path,
         ...
         pred_mask_path='',
         map_dis=20):
    print('generate_iteration_label_itr_0')
    ...
    for file_name in os.listdir(image_path):
        ...
        label_name = os.path.join(label_path, file_name.replace('.png','.json'))
        ...
        label_regions_center = get_label_point(image_np.shape, label_name)
